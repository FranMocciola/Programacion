...
def funcionPolinomica():
    ...
    def funcionPolinomica2():
        ...
        while i>=0:
            if i!= iAnt:
                label=tk.Label(ventana, text=f"Ingresar el termino del exponente {i}", font=("Times New Roman", 20),fg="white", bg="#212934")
                label.place(x=500, y=pos)
                campo2=tk.Entry(ventana)
                campo2.place(x=775, y=(pos+40),width=100, height=25)
            
                pos+=80
                botonOK2 = tk.Button(ventana, text="OK", font=("Arial",20,"bold"),width=8,bg="#334257",fg="white", command=leer)
                botonOK2.place(x=650, y=650)
    ...
    botonOK = tk.Button(ventana, text="OK", font=("Arial",20,"bold"),width=8,bg="#334257",fg="white", command=funcionPolinomica2)
    botonOK.place(x=600, y=500)
